...
public class JobControllerTest {
	...
	public void testCreateJob() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/jobs").content(MasterData.asJsonString(jobDTO))
	...
	public void testGetAllJobs() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/jobs").contentType(MediaType.APPLICATION_JSON)
	...
	public void testUpdateJob() throws Exception {
		...
		MvcResult result = mockMvc.perform(requestBuilder).andReturn();
		yakshaAssert(currentTest(),
				(result.getResponse().getContentAsString().contentEquals(MasterData.asJsonString(job)) ? "true"
						: "false"),
				businessTestFile);
	...
	public void testGetSearchJobsByJobTitle() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/jobs/search").queryParam("jobTitle", jobTitle)
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON);
	...
	public void testGetSearchJobsByCompany() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/jobs/search").queryParam("company", company)
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON);
	...
	public void testGetSearchJobsByLocation() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/jobs/search").queryParam("location", location)
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON);
	...
	public void testGetSearchJobsWithNoFilter() throws Exception {
		try {
			...
			yakshaAssert(currentTest(), e.getMessage().contains("Invalid search parameters") ? "true" : "false",
					businessTestFile);
		}
	}
